...
public class ViewCustomer2 extends JFrame implements ActionListener
{
	JLabel userLabel, eNameLabel, phoneLabel, addressLabel;
	JTextField userTF, phoneTF1, phoneTF2, eNameTF, addressTF;
	JButton refreshBtn,viewCustomerBtn,loadBtn, updateBtn, delBtn, backBtn, logoutBtn;
	JPanel panel;
	...
	public ViewCustomer2(String userId)
	{
		super("View Customer");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(text.equals(delBtn.getText()))
		{
			...
			deleteFromDB();
			ViewCustomer2 l = new ViewCustomer2(userId);
			l.setVisible(true);
			this.setVisible(false);
