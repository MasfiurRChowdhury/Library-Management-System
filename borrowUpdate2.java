...
public class borrowUpdate2 extends JFrame implements ActionListener
{
	JLabel userLabel;
	JTextField userTF;
	...
	public borrowUpdate2(String userId)
	{
		super("Borrow Update");
		...
		logoutBtn.setBounds(350, 300, 150, 30);
		logoutBtn.addActionListener(this);
		panel.add(logoutBtn);
		
		userLabel = new JLabel("Borrow ID : ");
		userLabel.setBounds(310, 150, 120, 30);
		panel.add(userLabel);
		...
		delBtn = new JButton("Return");
		delBtn.setBounds(270, 220, 120, 30);
		delBtn.addActionListener(this);
		panel.add(delBtn);
		
		backBtn = new JButton("Back");
		backBtn.setBounds(450, 220, 120, 30);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(text.equals(delBtn.getText()))
		{
			...
			deleteFromDB();
			borrowUpdate2 l = new borrowUpdate2(userId);
			l.setVisible(true);
			this.setVisible(false);
