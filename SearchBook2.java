...
{
	JLabel userLabel, eNameLabel, phoneLabel, addressLabel,borrowidLabel;
	JTextField userTF, phoneTF1, phoneTF2, eNameTF, addressTF,borrowTF;
	...
	public SearchBook2(String userId)
	{
		super("Search Book Window Customer");
