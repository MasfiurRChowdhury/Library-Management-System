...
public class borrowBook2 extends JFrame implements ActionListener
{
	...
	public borrowBook2(String userId)
	{
		super("Borrow Book");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{   
                        updateInDB();
						borrowBook2 ch = new borrowBook2(userId);
						ch.setVisible(true);
		...
		{
			ManageEmployee7 ch = new ManageEmployee7(userId);
						ch.setVisible(true);
						this.setVisible(false);
		}
