...
public class ManageEmployee6 extends JFrame implements ActionListener
{
	...
	public ManageEmployee6(String userId)
	{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			BookUpdate2 bu = new BookUpdate2(userId);
			bu.setVisible(true);
			this.setVisible(false);
		}
		...
		{
			bookEntry2 ve = new bookEntry2(userId);
			ve.setVisible(true);
			this.setVisible(false);
		}
		else if(text.equals(bookBtn.getText()))
		{
			SearchBook3 sb = new SearchBook3(userId);
			sb.setVisible(true);
			this.setVisible(false);
		}
